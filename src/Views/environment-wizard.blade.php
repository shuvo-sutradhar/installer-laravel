    ...
    <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
        ...
        <div class="tab" id="tab3content">
            ...
            <div class="form-group {{ $errors->has('admin_email') ? ' has-error ' : '' }}">
                ...
                <input type="text" name="admin_email" id="admin_email" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.admin_email') }}" />
            ...
            <div class="form-group {{ $errors->has('database_password') ? ' has-error ' : '' }}">
                ...
                <input type="password" name="admin_password" id="admin_password" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.admin_password') }}" />
                @if ($errors->has('database_password'))
                <span class="error-block">
                    <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
